...
export const CAMERA_SOURCES = Object.freeze([
  {
    id: "katase-higashihama-flyingsuika", siteId: "katase",
    name: "FlyingSuika 片瀬東浜", provider: "FlyingSuika", type: "youtube",
    url: "https://www.youtube.com/watch?v=xPgeZzojY5o", coverage: "nearby",
    history: CAMERA_HISTORY.DVR, cadence: "live", phenomena: ["sunrise", "sunset"],
    checkedOn: CAMERA_SOURCE_VERSION,
    evidence: "2026-09-06の実操作で約12時間巻戻し。画面時計14:05から02:01へ変化を確認。履歴は移動する。画像の朝焼け評価は未完了。",
  },
  {
